...
import type { InternshipApplication, Incident } from '../../../../services/internship/internshipService';
              ...
              <Table hover className="table align-middle mb-0">
                <thead className="bg-light">
                  <tr>
                    ...
                    <th className="border-0 py-3 text-muted small text-uppercase fw-semibold">Internship ID</th>
