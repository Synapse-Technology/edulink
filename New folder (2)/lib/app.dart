...
class EduLinkApp extends StatelessWidget {
  const EduLinkApp({Key? key}) : super(key: key);
...
class ProfileNavIcon extends StatelessWidget {
  ...
  const ProfileNavIcon({Key? key, this.size = 24, this.profilePicPath, this.firstName}) : super(key: key);
