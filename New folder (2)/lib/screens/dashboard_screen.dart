...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final firstName = _capitalize(first.split('.').first);
    final institution = 'Kenyatta University';
    final internshipEndsIn = 17;
    final internshipProgress = 0.68;
    final internshipTitle = 'Flutter Developer';
    final internshipCompany = 'Safaricom PLC';
    final internshipDuration = 'May 2024 – Aug 2024';
    final internshipOngoingProgress = 0.75;
    final metrics = [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text('$institution', style: const TextStyle(fontWeight: FontWeight.w500)),
                          const SizedBox(width: 6),
                          const Icon(Icons.school, color: Colors.teal, size: 18),
                          const SizedBox(width: 6),
                          Chip(
                            label: Text('Ends in $internshipEndsIn Days'),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(internshipCompany, style: const TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                      const SizedBox(height: 6),
                      Text(internshipTitle, style: Theme.of(context).textTheme.titleMedium),
                      const SizedBox(height: 4),
                      Text(internshipDuration, style: const TextStyle(color: Colors.black54)),
                      const SizedBox(height: 10),
                      Row(
                        children: [
                          Expanded(
