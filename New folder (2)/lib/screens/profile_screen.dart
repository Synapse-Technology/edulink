...
class ThemeProvider extends InheritedWidget {
  ...
  const ThemeProvider({required this.darkMode, required this.setDarkMode, required Widget child, Key? key}) : super(key: key, child: child);
...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  bool _institutionVerified = true;
  String? _profilePicPath;
  String? _cvPath;
  String? _admissionLetterPath;
  bool _twoFactor = false;
  bool _emailVerified = true;
  int _internshipsApplied = 4;
  int _internshipsApproved = 2;
  int _certificates = 1;
  String _lastLogin = '2 days ago';
  ...
  void initState() {
    ...
    final lastName = first.contains('.') ? _capitalize(first.split('.').last) : '';
