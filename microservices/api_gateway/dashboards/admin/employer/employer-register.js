// Employer Registration Form JavaScript
class EmployerRegistration {
    ...
    bindEvents() {
        ...
        document.querySelectorAll('.industry-option').forEach(option => {
            option.addEventListener('click', () => this.selectIndustry(option));
        });
    ...
    selectIndustry(option) {
        ...
        document.getElementById('industry').value = option.dataset.industry;
    ...
    validateStep2() {
        ...
        // Required fields
        const requiredFields = ['companyName', 'establishedYear', 'companySize'];
        ...
        reviewContent.innerHTML = `
            <div style="display: grid; gap: 2rem;">
                <div style="background: #f8fafc; padding: 1.5rem; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600;">Company Details</h4>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                        <div>
                            <strong>Industry:</strong><br>
                            <span style="color: #64748b;">${industryLabels[formData.industry] || formData.industry}</span>
                        </div>
                        <div>
                            <strong>Company Name:</strong><br>
                            <span style="color: #64748b;">${formData.company_name}</span>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <span style="color: #64748b;">${companySizeLabels[formData.company_size] || formData.company_size}</span>
                        </div>
    ...
    collectFormData() {
        ...
        // Automatically set role for employer registration
    ...
    async submitForm() {
        ...
        try {
            ...
            const response = await fetch('/api/registration/employers/', {
                method: 'POST',
                headers: {
