# Supabase-integrated settings for Auth Service
# This file demonstrates how to migrate from the current settings.py to Supabase
...
# Import our shared database configuration
...
# Environment variables with Supabase defaults
env = environ.Env(
    DEBUG=(bool, False),
    ...
    CROSS_SERVICE_ACCESS=(str, ''),  # Auth service typically doesn't need cross-service access
)
...
CROSS_SERVICES = env('CROSS_SERVICE_ACCESS').split(',') if env('CROSS_SERVICE_ACCESS') else []
...
# Database configuration using our shared system
DATABASES = configure_service_database(SERVICE_NAME)

# Add cross-service databases if needed (auth service typically doesn't need this)
if CROSS_SERVICES:
