...
class LogbookProvider extends ChangeNotifier {
  ...
  int requiredLogs = 12;
  final Map<int, String> _weeklyFeedback = {};
  final Map<int, String> _weeklyReport = {};
  final Map<int, String> _institutionReplies = {};
  final Map<int, String> _companyReplies = {};
  final Map<int, String> _trainingOfficerFeedback = {};
